    ...
    return Scaffold(
      ...
      body: Provider.of<SplashProvider>(context).hasConnection ? Stack(
        ...
        Container(
          ...
          color: Provider.of<ThemeProvider>(context).darkTheme ? ColorResources.latest : ColorResources.WHITE,
          child: CustomPaint(
        ...
        Center(
          child: Column(
            ...
            children: [
              Image.asset(Images.splashLogo, height: 250.0, fit: BoxFit.scaleDown,
                width: 250.0,),
            ],
          ),
        ),
