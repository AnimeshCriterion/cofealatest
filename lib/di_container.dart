...
import 'package:flutter_sixvalley_ecommerce/data/repository/gift_voucher_repo.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => BrandRepo(dioClient: sl()));
   ...
   sl.registerLazySingleton(() => GiftVoucherRepo(dioClient: sl()));
  ...
  sl.registerFactory(() => GiftVoucherProvider(giftVoucherRepo:  sl()));
